@SIT-HVE_FDR_CCE-IT02-AceCheckAPI-Map-New-Elements-GFSPost @NoAPIGEE @SIT-HVE_FDR_CCE @Regression_SIT-HVE_FDR_CCE @B-129398-SIT @B-130862-SIT @SIT-HVE_FDR_CCE_IT02
Feature: AceCheckAPI Map New Elements for HVE/FDR CCE from HVS Response to GFS POST

Scenario Outline: AceCheckAPI Map New Elements for HVE/FDR CCE  from HVS Response to GFS POST
	...
	And User verifies the following data elements from ACE Check API "HVEResponse" data are mapped to "GFSPostData"
